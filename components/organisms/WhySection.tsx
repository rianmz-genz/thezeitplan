...
const WhySection = () => {
  ...
  return (
    <Container>
      <SpaceNavbar />
      <aside className="w-full flex lg:flex-row flex-col space-y-10 lg:space-y-0 justify-between">
        <div className="lg:w-4/12 w-full space-y-10">
          <SectionParagraph
        ...
        <div className="lg:w-7/12 w-full grid grid-cols-1 gap-y-3 lg:grid-cols-2 lg:gap-6">
          {whyCard.map((feature) => (
            <WhyCard
              key={feature.title}
              icon={feature.icon}
